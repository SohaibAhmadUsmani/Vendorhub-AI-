...
const TINT_MAP = {
    ...
    // Buyer
    "create-rfq": "bg-[#EDE9FE] text-[#7C3AED]",
    "buyer-ai-search": "bg-[#E0E7FF] text-[#4F46E5]",
    "compare-quotes": "bg-[#FFEDD5] text-[#F97316]",
    "messages": "bg-[#DBEAFE] text-[#2563EB]",
    "saved-vendors": "bg-[#DCFCE7] text-[#16A34A]",
    "view-orders": "bg-[#E0F2FE] text-[#0284C7]",
};
...
function QuickActionButton({ action, index }) {
    ...
    const tint =
        TINT_MAP[action.id] ?? "bg-[var(--pastel-purple)] text-[var(--primary-purple)]";
